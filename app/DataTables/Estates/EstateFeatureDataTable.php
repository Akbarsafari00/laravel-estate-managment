...
class EstateFeatureDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function (EstateFeatures $model) {
                return view('pages.estate-features._action-menu', compact('model'));
            });
    }


    public function query(EstateFeatures $model)
    {
