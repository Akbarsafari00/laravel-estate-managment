...
use App\DataTables\Estates\EstateDocumentTypesDataTable;
use App\DataTables\Estates\EstateFeatureDataTable;
use App\DataTables\Estates\EstateSubscriptionsDataTable;
...
class EstateSubscriptionsController extends Controller
{
    /**
     ...
     */
    public function index(EstateSubscriptionsDataTable $dataTable)
    {
        return $dataTable->render('pages.estate-subscriptions.index');
    }
