...
class EstateDocumentTypeController extends Controller
{
    /**
     ...
     */
    public function index(EstateDocumentTypesDataTable $dataTable)
    {
        return $dataTable->render('pages.estate-document-types.index');
    }
