...
class EstateFeaturesController extends Controller
{
    /**
     ...
     */
    public function index(EstateFeatureDataTable $dataTable)
    {
        return $dataTable->render('pages.estate-features.index');
    }
